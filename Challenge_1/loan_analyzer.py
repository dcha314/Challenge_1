...
print("There are", num_loan, "in this list.")
...
loan_tot = sum(loan_costs)

print("The total of this list is: $", loan_tot)

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount

loan_avr = loan_tot / num_loan

print("The average loan costs: $", loan_avr)
...
for loan in loans:
    if loan.get("loan_price") <= 500:
        ...
        print("Loan added to list!") 
    else: 
        print("This loan is not suitable...")
